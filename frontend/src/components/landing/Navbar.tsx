      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/connections" className="text-sm font-medium text-gray-600 hover:text-primary-600 transition-colors">Academic & Alumni</Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/register" className="px-5 py-2.5 rounded-xl bg-primary-600 text-white text-sm font-semibold hover:bg-primary-700 transition-colors shadow-md shadow-primary-500/20">
              Get Started
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-gray-200 shadow-lg">
          <div className="px-4 pt-2 pb-6 space-y-1 sm:px-3">
            ...
            <Link to="/connections" onClick={() => setIsOpen(false)} className="block px-3 py-3 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-primary-600">Academic & Alumni</Link>
            ...
            <div className="pt-4 flex flex-col space-y-3">
              ...
              <Link to="/register" className="w-full text-center px-4 py-3 rounded-xl bg-primary-600 text-white text-base font-semibold hover:bg-primary-700">Get Started</Link>
            </div>
          </div>
        </div>
      )}
